 ...
 */
(function($){"use strict";$('.switcher-setting').on('click',function(){if($('#style-switcher').hasClass('active')){$('#style-switcher').removeClass('active');}else{$('#style-switcher').removeClass('active');$('#style-switcher').addClass('active');}});$('.boxed,.pattren-wrap a').on('click',function(){$('.main-wrapper').addClass('wrapper-boxed');$('.main-wrapper').removeClass('wrapper-wide');$(window).resize();});$('.wide').on('click',function(){$('.main-wrapper').addClass('wrapper-wide');$('.main-wrapper').removeClass('wrapper-boxed');$(window).resize();});$('.bg-list li a').on('click',function(){var bg=$(this).css("backgroundImage");$("body").css("backgroundImage",bg);$(window).resize();});$(".style1").on("click",function(){$("#colors").attr("href","css/styles.css");$("#logo").attr("src","img/logos/logo-color-01.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");$(window).on('scroll',function(){var scroll=$(window).scrollTop();var innerlogo=$(".navbar-brand.inner-logo img");if(scroll<=50){innerlogo.attr('src','img/logos/logo-white.png');} else{innerlogo.attr('src','img/logos/logo-color-01.png');}});return false;});$(".style2").on("click",function(){$("#colors").attr("href","css/styles-2.css");$("#logo").attr("src","img/logos/logo-color-02.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");$(window).on('scroll',function(){var scroll=$(window).scrollTop();var innerlogo=$(".navbar-brand.inner-logo img");if(scroll<=50){innerlogo.attr('src','img/logos/logo-white.png');} else{innerlogo.attr('src','img/logos/logo-color-02.png');}});return false;});$(".style3").on("click",function(){$("#colors").attr("href","css/styles-3.css");$("#logo").attr("src","img/logos/logo-color-03.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");$(window).on('scroll',function(){var scroll=$(window).scrollTop();var innerlogo=$(".navbar-brand.inner-logo img");if(scroll<=50){innerlogo.attr('src','img/logos/logo-white.png');} else{innerlogo.attr('src','img/logos/logo-color-03.png');}});return false;});$(".style4").on("click",function(){$("#colors").attr("href","css/styles-4.css");$("#logo").attr("src","img/logos/logo-color-04.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");$(window).on('scroll',function(){var scroll=$(window).scrollTop();var innerlogo=$(".navbar-brand.inner-logo img");if(scroll<=50){innerlogo.attr('src','img/logos/logo-white.png');} else{innerlogo.attr('src','img/logos/logo-color-04.png');}});return false;});$(".style5").on("click",function(){$("#colors").attr("href","css/styles-5.css");$("#logo").attr("src","img/logos/logo-color-05.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");$(window).on('scroll',function(){var scroll=$(window).scrollTop();var innerlogo=$(".navbar-brand.inner-logo img");if(scroll<=50){innerlogo.attr('src','img/logos/logo-white.png');} else{innerlogo.attr('src','img/logos/logo-color-05.png');}});return false;});$(".style6").on("click",function(){$("#colors").attr("href","css/styles-6.css");$("#logo").attr("src","img/logos/logo-color-06.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");$(window).on('scroll',function(){var scroll=$(window).scrollTop();var innerlogo=$(".navbar-brand.inner-logo img");if(scroll<=50){innerlogo.attr('src','img/logos/logo-white.png');} else{innerlogo.attr('src','img/logos/logo-color-06.png');}});return false;});$(".style7").on("click",function(){$("#colors").attr("href","css/styles-7.css");$("#logo").attr("src","img/logos/logo-color-07.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");$(window).on('scroll',function(){var scroll=$(window).scrollTop();var innerlogo=$(".navbar-brand.inner-logo img");if(scroll<=50){innerlogo.attr('src','img/logos/logo-white.png');} else{innerlogo.attr('src','img/logos/logo-color-07.png');}});return false;});$(".style8").on("click",function(){$("#colors").attr("href","css/styles-8.css");$("#logo").attr("src","img/logos/logo-color-08.png");$(".white-logo #logo").attr("src","img/logos/logo-white.png");$(window).on('scroll',function(){var scroll=$(window).scrollTop();var innerlogo=$(".navbar-brand.inner-logo img");if(scroll<=50){innerlogo.attr('src','img/logos/logo-white.png');} else{innerlogo.attr('src','img/logos/logo-color-08.png');}});return false;});})(jQuery);